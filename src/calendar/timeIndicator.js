...
import useInterval from "fitbud/hooks/useInterval";
import moment from "moment";
import React from "react";
import { findCoordinates } from "./helpers";
import { CELL_HEIGHT, CELL_WIDTH } from "./useCalendarBaseStyles";

export default function TimeIndicator({scrollToNow, updateInterval, dates, timeInterval}) {
  ...
  return (
    <div className={`${classes.nowIndicator} d-flex align-items-center`} id='time-indicator' >
