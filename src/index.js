    ...
    <Paper className={classes.root} >
      ...
      <TableContainer className={classes.container} id='calendar-root'>
        <Table className={classes.table}>
          <CalendarHeader dates={dates} headerCellComponent={headerCellComponent} showScrollButtons={showScrollButtons} />
          <CalendarBody slots={slots} hideGrid={hideGrid} />
        </Table>
        <Sessions data={data} dates={dates} timeInterval={timeInterval} sessionComponent={sessionComponent} />
        <TimeIndicator 
